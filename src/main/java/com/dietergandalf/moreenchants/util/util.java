...
public class util {
    ...
    public static final List<Block> TREE_STEM = List.of(
            Blocks.OAK_LOG, Blocks.SPRUCE_LOG,
            Blocks.DARK_OAK_LOG, Blocks.BIRCH_LOG,
    ...
    public static boolean checkLog(Block block) {return TREE_STEM.contains(block);}
